...
export function SourcePanel({
  ...
  return (
    <Collapsible open={isOpen} onOpenChange={onOpenChange}>
      ...
      <CollapsibleContent className="absolute md:relative left-0 top-0 z-20 h-full data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:slide-out-to-left data-[state=open]:slide-in-from-left">
        <aside
          className="w-64 sm:w-72 xl:w-80 h-full border-r bg-background overflow-y-auto shadow-lg md:shadow-none"
